...
const ResearchAndBenefits = () => {
  return (
    <div className="bg-white mt-14 font-mono p-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6">
        <section className="bg-[#c9f7f5] rounded-lg p-6 flex-1 ">
          <h4 className="font-mono font-semibold text-2xl mb-4 text-[#0f172a]">
            Research Areas
          </h4>
          <ul className="font-mono text-[#475569] space-y-2 list-disc list-inside">
