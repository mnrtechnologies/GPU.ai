...
const HardwareSolutions = () => {
  ...
  `,
      ...
      <PerformanceFeatures performanceData={performanceData} title="Hardware Specifications" description="Enterprise-grade hardware solutions optimized for AI and high-performance computing workloads" />

      <GpuArchitecture img = {"https://images.unsplash.com/photo-1665686376173-ada7a0031a85?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&h=700&q=80"}/>
